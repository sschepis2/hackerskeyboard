...
public class Keyboard {
    ...
    public Keyboard(Context context, int defaultHeight, int xmlLayoutResId, int modeId, float kbHeightPercent) {
        ...
        //Log.i("smartkey", "mDefaultHeight=" + mDefaultHeight + "(arg=" + defaultHeight + ")" + " kbHeight=" + mKeyboardHeight + " displayHeight="+mDisplayHeight+")");
...
//        }
    ...
    private void fixAltChars(Locale locale) {
        ...
        for (Key key : mKeys) {
            ...
            //Log.i("smartkey", "popup for " + key.label + " '" + key.popupCharacters + "' => '"+ newPopup + "' length " + newPopup.length());
    ...
    public void setKeyboardWidth(int newWidth) {
        ...
        Log.i("smartkey", "Rescaling keyboard: " + mTotalWidth + " => " + newWidth);
        for (Key key : mKeys) {
