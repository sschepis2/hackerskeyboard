...
public class BinaryDictionary extends Dictionary {
    ...
    static {
        try {
            System.loadLibrary("jni_smartkey");
            Log.i("smartkey", "loaded jni_smartkey");
        } catch (UnsatisfiedLinkError ule) {
            Log.e("BinaryDictionary", "Could not load native library jni_smartkey");
        }
    }
    ...
    private final void loadDictionary(InputStream[] is) {
        try {
            ...
            if (mDictLength > 10000) Log.i("smartkey", "Loaded dictionary, len=" + mDictLength);
        } catch (IOException e) {
