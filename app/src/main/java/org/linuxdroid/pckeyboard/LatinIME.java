...
package org.linuxdroid.smartkey;

import org.linuxdroid.smartkey.LatinIMEUtil.RingCharBuffer;
...
public class LatinIME extends InputMethodService implements
    ...
    private static final String TAG = "smartkeyIME";
    private static final String NOTIFICATION_CHANNEL_ID = "smartkey";
    ...
    public void onCreate() {
        Log.i("smartkey", "onCreate(), os.version=" + System.getProperty("os.version"));
    ...
    public void onConfigurationChanged(Configuration conf) {
        Log.i("smartkey", "onConfigurationChanged()");
    ...
    public void onStartInputView(EditorInfo attribute, boolean restarting) {
        ...
        //Log.i("smartkey", "onStartInputView " + attribute + ", inputType= " + Integer.toHexString(attribute.inputType) + ", restarting=" + restarting);
...
//                .obtainMessage(MSG_UPDATE_SHIFT_STATE), 300);
    ...
    public void onSharedPreferenceChanged(SharedPreferences sharedPreferences,
            String key) {
        Log.i("smartkey", "onSharedPreferenceChanged()");
    ...
    static int getPrefInt(SharedPreferences prefs, String prefName, int defVal) {
        ...
        //Log.i("smartkey", "getPrefInt " + prefName + " = " + prefVal + ", default " + defVal);
