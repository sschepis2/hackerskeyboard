...
public class NotificationReceiver extends BroadcastReceiver {
    static final String TAG = "smartkey/Notification";
    static public final String ACTION_SHOW = "org.linuxdroid.smartkey.SHOW";
    static public final String ACTION_SETTINGS = "org.linuxdroid.smartkey.SETTINGS";
